  ...
  return (
    <div className="min-h-dvh bg-bg md:flex">
      ...
      <div className="flex min-h-dvh flex-1 flex-col">
        <NetworkBanner />
        <main className="mx-auto w-full max-w-lg flex-1 px-4 pb-[calc(var(--nav-h)+var(--safe-bottom)+4.5rem)] pt-[max(1rem,env(safe-area-inset-top))] md:max-w-3xl md:px-8 md:pb-10">
          {children}
        </main>
